...
import { processSmartSearch } from '../../lib/groq'
...
export const Search = () => {
  ...
  const searchTitle = q ? `${q} - البحث | فور سيما` : 'البحث | فور سيما'
  const searchDesc = q
    ? `نتائج البحث عن "${q}" - أفلام، مسلسلات، ألعاب، برمجيات على فور سيما`
    : 'ابحث عن الأفلام والمسلسلات حسب الاسم والتصنيف والسنة والتقييم على فور سيما'
